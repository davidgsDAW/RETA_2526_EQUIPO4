...
- Una **aplicación de escritorio en Java** con interfaz Swing, perfiles de Administrador y Profesor, y generación de informes.
- Una **base de datos MySQL** alojada en un servidor virtualizado (MV1) con el inventario del taller.
...
| Juan Camilo Vallejo Reyes | Desarrollador de BD |
...
| **Draw.io (Diagrams.net)** | Creación de diagramas E/R, clases, casos de uso y red |
...
La base de datos `Taller_Informatica` almacena toda la información del inventario del taller.
...
Aplicación de escritorio con interfaz Swing para la gestión del inventario.
...
Sitio web con HTML5, CSS3 y JavaScript que muestra gráficamente la distribución del taller y permite localizar visualmente cada componente.
...
- [Mapa profesional del equipo](/Documentacion/IPE1/Equipo4-IPEI-Tarea1-MapaProfesional.pdf)
...
- La implementación de una base de datos normalizada con todas las categorías de material exigidas.
